        ...
        <HeaderSticky aria-label='Main site header' className='ui-container' dataClasses='ui-shadow'>
            <Grid.Row fluid='no'>
                <Grid.Col size={9} md={3} sm={3} xs={3}>
                    ...
                    <Button square ghost title='Toggle Nav' className='ui-sidebar-show-l ui-round ui-shown-md ui-mirror-rtl'>
                ...
                <Grid.Col size={3} md={9} sm={9} xs={9} className='ui-align-r ui-icons-no-opacity'>
                    ...
                    {showRightSidebar &&
                        <Button square ghost title='Toggle Menu' className='ui-sidebar-show-r ui-align-c ui-round ui-shown-md ui-mirror-rtl'>
