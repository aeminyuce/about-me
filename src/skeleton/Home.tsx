        ...
        <Grid.Container fixed='xl' as='div'>
            <Grid.Row fluid='sm' hGap='lg' className='ui-m-15-v'>
                ...
                <Grid.Col size={7} md={10} className='ui-sm-align-c ui-round-1st'>
                    <Skeleton clear w='186px' h='31px' className='ui-m-20-b' />
                    <Skeleton clear repeat={2} w='150px' h='18px' vGap={5} />

                    <Grid.Row fluid='sm' className='ui-m-15-b ui-m-10-t'>

                        <Grid.Col xl={8} lg={8} size={10} className='ui-round-1st'>
                            <Skeleton w='100%' h='18px' className='ui-m-5-v ui-hidden-md' />
                            <Skeleton repeat={2} w='100%' h='18px' className='ui-m-5-v ui-visible-md' />
                            <Skeleton w='60%' h='18px' className='ui-m-5-v' />
                        </Grid.Col>

                    </Grid.Row>

                    <Skeleton w='172px' h='48px' className='ui-circle' />
                </Grid.Col>
            ...
            <Grid.Row>
                ...
                <Grid.Col size={8} push={2} className='ui-m-30-v ui-align-c ui-round-2nd'>
                    <div className='ui-hidden-md'>
                        <Skeleton w='100%' h='23px' className='ui-m-5-v' />
                        <Skeleton w='86%' h='23px' className='ui-m-5-t ui-m-20-b' />
                    </div>
                    <div className='ui-visible-md'>
                        <Skeleton repeat={5} w='100%' h='20px' className='ui-m-5-v ui-visible-md' />
                        <Skeleton w='86%' h='20px' className='ui-m-5-t ui-m-20-b' />
                    </div>
                </Grid.Col>
        ...
        <Grid.Row className='ui-p-15-h ui-no-m-h ui-m-15-b'>
            <Grid.Static fluid='no'>
                ...
                <Grid.Col size={85} className='ui-p-10-v'>
                    ...
                    <Skeleton w='37px' h='42px' className='ui-m-1-l ui-round-r' />
                </Grid.Col>
