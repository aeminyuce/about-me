    ...
    return (
        ...
        <Preview>
            <Breadcrumbs className={underlineWrapperClasses}>
                <Breadcrumbs.Item pos={'1'} to='#'>Home</Breadcrumbs.Item>
                <Breadcrumbs.Item pos={'2'} to='#'>Search Results</Breadcrumbs.Item>
                <Breadcrumbs.Item pos={'3'}>
            ...
            <Breadcrumbs className={opacityWrapperClasses}>
                <Breadcrumbs.Item pos={'1'} className={opacityClasses} to='#'>Home</Breadcrumbs.Item>
                <Breadcrumbs.Item pos={'2'} className={opacityClasses} to='#'>Search Results</Breadcrumbs.Item>
                <Breadcrumbs.Item pos={'3'}>Details</Breadcrumbs.Item>
            </Breadcrumbs>
        </Preview>
